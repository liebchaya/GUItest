...
//		setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
	    ...
	    JButton SaveBtn = new JButton("שמור שיפוטים");
...
//       this.setJMenuBar(menubar);
	...
	private void loadExpTable(boolean isAncient){
	...
	private void loadTableData(boolean isAncient){
	 ...
	 */
	private void DrawJudgementPanel(JPanel panel, boolean isAncient){
		JTable table;
		JTable expTable;
