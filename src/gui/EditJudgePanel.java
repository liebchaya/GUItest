...
//		m_panel.add(Text,  BorderLayout.NORTH);
		...
		final JButton AddBtn = new JButton("הוספת ערכים ידנית");
...
//	    
	    table.getColumn("ה.קבוצה").setCellRenderer(new AddEditGroupButtonRenderer());
	    table.getColumn("ה.קבוצה").setCellEditor(
	            new AddEditGroupButtonEditor(new JCheckBox()));
	    
	    table.getColumn("ה.הרחבה").setCellRenderer(new AddEditExpansionButtonRenderer());
